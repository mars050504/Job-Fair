        ...
        <div className='max-w-7xl mx-auto my-10'>
            <div className='flex items-center justify-between'>
                ...
                <Button disabled={isApplied}
                    className={`rounded-lg ${isApplied ? 'bg-gray-600 cursor-not-allowed' : 'bg-[#7209B7] hover:bg-[5f3ad]'}`}>
            ...
            <div className='my-4'>
                ...
                <h1 className='font-bold my-1'>Description:<span className='pl-4 font-normal text-gray-800'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi ipsa debitis quae iste, obcaecati exercitationem? Iure deleniti mollitia, aperiam distinctio, incidunt soluta vel exercitationem recusandae, hic dignissimos laborum pariatur doloribus.</span></h1>
                ...
                <h1 className='font-bold my-1'>Posted Date:<span className='pl-4 font-normal text-gray-800'></span>02-05-2025</h1>
            </div>
        </div>
    )
}
